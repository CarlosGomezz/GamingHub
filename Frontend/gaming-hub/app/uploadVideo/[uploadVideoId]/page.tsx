...
export default function UploadVideo({
    ...
    const handleUpload = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        setVideoCreatorId(1); // PUESTO DE MANERA PROVISIONAL PORQUE NO HAY CREATOR EN LA BBDD

        const formData = new FormData();
        formData.append("video_data", selectedFile);
        formData.append("game", String(params.uploadVideoId));
    ...
    return (
        <div>
            ...
            <form
                ...
                className="p-5 border-red-100 border-2"
            >
                <div>
                    <label id="floating_title">Title</label>
                    <input
                        value={videoTitle}
                ...
                <br></br>
                <div>
                    <label id="floating_description">Description</label>
                    <input
                ...
                <button type="submit" className="border-4 p-5 bg-red-400">
                    Upload Video
                </button>
            </form>
